...
define( 'EVOLUTION_THEME_VERSION', wp_get_theme()->Version );
...
define( 'EVOLUTION_INCLUDES_DIR', EVOLUTION_INC_DIR . '/includes' );
define( 'EVOLUTION_META_DIR', EVOLUTION_INC_DIR . '/meta' );
define( 'EVOLUTION_HELPER_DIR', EVOLUTION_FUNCTIONS_DIR . '/helper' );
define( 'EVOLUTION_SETUP_DIR', EVOLUTION_FUNCTIONS_DIR . '/setup' );
define( 'EVOLUTION_SHORTCODES_DIR', EVOLUTION_INC_DIR . '/shortcodes' );
...
/* Metaboxes */
require_once( EVOLUTION_META_DIR . '/meta-start.php' );

// Shortcodes Functions
require_once ( EVOLUTION_SHORTCODES_DIR . '/shortcode-functions.php' );		
// Shortcode processing
require_once ( EVOLUTION_SHORTCODES_DIR . '/shortcode-execution.php' );
