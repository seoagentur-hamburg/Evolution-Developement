...
function evolution_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section("general", array(
        "title" => __("Google Maps API Key", "evolution"),
        "priority" => 35,
    ));
    // Die Einstellungen definieren  
    $wp_customize->add_setting('general-key', array(
        'default'           => '',
    ...
    $wp_customize->add_control(new WP_Customize_Control(
        ...
        "general-key",
        array(
            "label" => __("Google Maps API Key", "evolution"),
            "section" => "general",
...
// Die Eingabemöglichkeit erstellen
    ...
    $wp_customize->add_section("header", array(
        "title" => __("Header Display", "evolution"),
        "priority" => 50,
    ));
    // Die Einstellungen definieren  
    ...
    // Die Eingabemöglichkeit erstellen
    $wp_customize->add_control( 'header-display', array(
        'label'   => esc_html__( 'Choose your Header', 'evolution' ),
        'section' => 'header',
        'type'    => 'radio',
        'choices' => array(
            'header-1'     => esc_html__( 'Display small header with navigation inside', 'evolution' ),
            'header-2'     => esc_html__( 'Display big header with navigation below', 'evolution' ),
        ),
        'priority' => 25,
    ) ); 
    
    // Die Einstellungen definieren  
    $wp_customize->add_setting('header-para', array(
        'default'           => '',
        'capability' => 'edit_theme_options',
    ));

    // Die Eingabemöglichkeit erstellen
    $wp_customize->add_control( 'header-para', array(
        'label'   => esc_html__( 'Header Parallax Effect', 'evolution' ),
        'section' => 'header',
        'type'    => 'radio',
        'choices' => array(
            'true'     => esc_html__( 'Display header with parallax effect', 'evolution' ),
            'false'     => esc_html__( 'Display header without effect', 'evolution' ),
        ),
        'priority' => 30,
    ) ); 
