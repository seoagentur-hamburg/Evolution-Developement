	...
	public function __construct() {
		...
		$this->profiles = apply_filters( 'evolution_social_default_profiles', array(
			...
			'website' => array(
				...
				'pattern'	  => '<li class="social-website"><a href="%s" %s title="Website"><i class="icon-link" aria-hidden="true"></i></a></li>',
			),
			'facebook' => array(
				'label'		  => __( 'Facebook URI', 'evolution' ),
				'pattern'	  => '<li class="social-facebook"><a href="%s" %s title="Facebook"><i class="icon-facebook" aria-hidden="true"></i></a></li>',
			),
            'twitter' => array(
				'label'		  => __( 'Twitter URI', 'evolution' ),
				'pattern'	  => '<li class="social-twitter"><a href="%s" %s title="Twitter"><i class="icon-twitter" aria-hidden="true"></i></a></li>',
			),
            'gplus' => array(
				'label'		  => __( 'Google+ URI', 'evolution' ),
				'pattern'	  => '<li class="social-gplus"><a href="%s" %s title="Google +"><i class="icon-google-plus" aria-hidden="true"></i></a></li>',
			),
			'flickr' => array(
				'label'		  => __( 'Flickr URI', 'evolution' ),
				'pattern'	  => '<li class="social-flickr"><a href="%s" %s title="Flickr"><i class="icon-flickr" aria-hidden="true"></i></a></li>',
			),
			'github' => array(
				'label'		  => __( 'GitHub URI', 'evolution' ),
				'pattern'	  => '<li class="social-github"><a href="%s" %s title="GitHub"><i class="icon-github" aria-hidden="true"></i></a></li>',
			),
			'instagram' => array(
				'label'		  => __( 'Instagram URI', 'evolution' ),
				'pattern'	  => '<li class="social-instagram"><a href="%s" %s title="Instagram"><i class="icon-instagram" aria-hidden="true"></i></a></li>',
			),
			'linkedin' => array(
				'label'		  => __( 'Linkedin URI', 'evolution' ),
				'pattern'	  => '<li class="social-linkedin"><a href="%s" %s title="LinkedIn"><i class="icon-linkedin" aria-hidden="true"></i></a></li>',
			),
			'pinterest' => array(
				'label'		  => __( 'Pinterest URI', 'evolution' ),
				'pattern'	  => '<li class="social-pinterest"><a href="%s" %s title="Pinterest"><i class="icon-pinterest" aria-hidden="true"></i></a></li>',
			),
			'rss' => array(
				'label'		  => __( 'RSS URI', 'evolution' ),
				'pattern'	  => '<li class="social-rss"><a href="%s" %s title="RSS Feed"><i class="icon-rss" aria-hidden="true"></i></a></li>',
			),
			'stumbleupon' => array(
				'label'		  => __( 'StumbleUpon URI', 'evolution' ),
				'pattern'	  => '<li class="social-stumbleupon"><a href="%s" %s title="StumbleUpon"><i class="icon-stumbleupon" aria-hidden="true"></i></a></li>',
			),
            'dribbble' => array(
				'label'		  => __( 'Dribbble URI', 'evolution' ),
				'pattern'	  => '<li class="social-dribbble"><a href="%s" %s title="Dribbble"><i class="icon-dribbble" aria-hidden="true"></i></a></li>',
			),
			'vimeo' => array(
				'label'		  => __( 'Vimeo URI', 'evolution' ),
				'pattern'	  => '<li class="social-vimeo"><a href="%s" %s title="Vimeo"><i class="icon-vimeo" aria-hidden="true"></i></a></li>',
			),
			'youtube' => array(
				'label'		  => __( 'YouTube URI', 'evolution' ),
				'pattern'	  => '<li class="social-youtube"><a href="%s" %s title="YouTube"><i class="icon-youtube" aria-hidden="true"></i></a></li>',
			),
            'xing' => array(
				'label'		  => __( 'Xing URI', 'evolution' ),
				'pattern'	  => '<li class="social-xing"><a href="%s" %s title="Xing"><i class="icon-xing" aria-hidden="true"></i></a></li>',
			),
		) );
